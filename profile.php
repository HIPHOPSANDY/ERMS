...
<body class="hold-transition skin-blue sidebar-mini">
												...
												<div class="row">
													<div class="col-lg-3">
														<div class="form-group">
															...
															<p name="first_name" id="first_name" ><?php echo $data['first_name']; ?></p>
														</div>
													</div>
													<div class="col-lg-3">
														<div class="form-group">
  ...
  <!-- <thead>
    <tr>
      ...
      <th scope="col"><p name="first_name" id="first_name" ><?php echo $data['first_name']; ?></p></th>
  ...
  <tbody>
    ...
    <tr>
      ...
      <td><p name="first_name" id="first_name" ><?php echo $data['first_name']; ?></p></td>
    </tr>
    <tr>
      <td><b>Last Name</b></td>
      <td><p name="first_name" id="first_name" ><?php echo $data['last_name']; ?></p></td>
    </tr>
	<tr>
      <td><b>Date of Birth</b></td>
      <td><p name="first_name" id="first_name" ><?php echo $data['dob']; ?></p></td>
    </tr>
	<tr>
      <td><b>Gender</b></td>
      <td><p name="first_name" id="first_name" ><?php echo $data['gender'] ?></p></td>
    </tr>
	<tr>
      <td><b>Address</b></td>
      <td><p name="first_name" id="first_name" ><?php echo $data['address']; ?></p></td>
    </tr>
	<tr>
      <td><b>City</b></td>
      <td><p name="first_name" id="first_name" ><?php echo $data['city']; ?></p></td>
    </tr>
	<tr>
      <td><b>State</b></td>
      <td><p name="first_name" id="first_name" ><?php echo $data['state']; ?></p></td>
    </tr>
	<tr>
      <td><b>Country</b></td>
      <td><p name="first_name" id="first_name" ><?php echo $data['country']; ?></p></td>
    </tr>
	<tr>
      <td><b>Email</b></td>
      <td><p name="first_name" id="first_name" ><?php echo $data['email']; ?></p></td>
    </tr>
	<tr>
      <td><b>Designation</b></td>
      <td><p name="first_name" id="first_name" ><?php echo $data['designation']; ?></p></td>
    </tr>
	<tr>
      <td><b>Department</b></td>
      <td><p name="first_name" id="first_name" ><?php echo $data['department']; ?></p></td>
    </tr>
