			...
			<?php if ( $attendanceROW < 2 ) { ?>
				<form method="POST" class="employee sidebar-form" role="form" id="attendance-form">
	                <div class="input-group">
	                    <!-- <input type="text" class="form-control" id="desc" name="desc" placeholder="Comment* (In & Out message)" /> -->
	                    <!-- <span class="input-group"> -->
	                    	<button type="submit" id="action_btn" class="btn btn-warning" style="width: 214px; ;"><?php echo $action_name; ?></button>
	                    <!-- </span> -->
	                </div>
	            </form>
	        <?php } ?>
			...
			<?php if ( $_SESSION['Login_Type'] == 'admin' ) { ?>
				<li class="<?php echo $page_name == "holidays" ? 'active' : ''; ?>">
					<a href="<?php echo BASE_URL; ?>registration/">
						<i class="fa fa-calendar-check-o"></i> <span>Employee Registration</span>
					</a>
				</li>
