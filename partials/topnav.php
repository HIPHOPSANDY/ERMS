<header class="main-header" >
	<a href="<?php echo BASE_URL; ?>" class="logo" style="background: #222d32;"   >
		
		<span  class="logo-lg"><b style="color: #ecf0f5;">E R M S</b></span>
	</a>
	<nav class="navbar navbar-static-top" role="navigation" style="background: #222d32;" >
		<a href="#" class="sidebar-toggle" data-toggle="offcanvas" role="button" style="background: #222d32;">
